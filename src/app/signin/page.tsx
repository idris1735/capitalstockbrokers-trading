    ...
    >
      ...
      <div className="w-full max-w-sm bg-white/20 backdrop-blur-md rounded-2xl shadow-lg border border-white/30 p-6 space-y-4 relative z-10">
        ...
        <div className="text-center space-y-1">
          <h1 className="text-2xl font-semibold text-white">Sign in with your username</h1>
        ...
        <form className="space-y-3">
          ...
          <div className="text-right">
            <a href="#" className="text-white/80 hover:text-[#FFA500] transition-colors text-xs">
              Forgot password?
            </a>
          </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <p className="text-white/80 text-xs">Or sign in with</p>
            <div className="flex-1 h-px bg-white/30"></div>
          </div>
        ...
        <div className="text-center">
          <p className="text-white/80 text-sm">
            ...
            <Link href="/signup" className="text-[#FFA500] hover:text-[#FFA500]/90 font-medium transition-colors">
              Sign up
            </Link>
          </p>
        </div>
